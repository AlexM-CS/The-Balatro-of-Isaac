                    ...
                    for i = 1, #G.jokers.cards do
                        if G.jokers.cards[i].config.center_key == "j_tboi_binge_eater" then
                            ...
                            if G.jokers.cards[i].ability.extra.face_repetitions == nil then
                                G.jokers.cards[i].ability.extra.face_repetitions = card.ability.extra.repetitions
                            else
                                G.jokers.cards[i].ability.extra.face_repetitions = G.jokers.cards[i].ability.extra.face_repetitions + card.ability.extra.repetitions
                            end
                        end
                    end
                end
